 ...
 * implement IResourceLoaderAware.
 *
 * PHP Version 5
 *
 * @category   Ding
 ...
 * @link       http://marcelog.github.com/
 */
class ResourceLoaderAwareDriver implements IAfterCreateListener
{
    /**
    ...
    public function afterCreate(IBeanFactory $factory, $bean, BeanDefinition $beanDefinition)
    {
        ...
        if ($rClass->implementsInterface('Ding\Resource\IResourceLoaderAware')) {
            $bean->setResourceLoader($factory);
        }
        return $bean;
    }
     ...
     *
     * @return ResourceLoaderAwareDriver
     */
    public static function getInstance(array $options)
    {
        if (self::$_instance == false) {
            self::$_instance = new ResourceLoaderAwareDriver;
        }
