<?php
/**
 * This driver will make the injection of the logger in use by the container
 * for beans that implement IContainerAware.
 *
 * PHP Version 5
 *
 * @category   Ding
 ...
 * @link       http://marcelog.github.com/
 */
class LoggerAwareDriver implements IAfterCreateListener
{
    /**
    ...
    public function afterCreate(IBeanFactory $factory, $bean, BeanDefinition $beanDefinition)
    {
        ...
        if ($rClass->implementsInterface('Ding\Logger\ILoggerAware')) {
            $bean->setLogger($factory->getLogger($class));
        }
        return $bean;
    }
     ...
     *
     * @return LoggerAwareDriver
     */
    public static function getInstance(array $options)
    {
        if (self::$_instance == false) {
            self::$_instance = new LoggerAwareDriver;
        }
